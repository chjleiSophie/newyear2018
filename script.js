window.onload = function () {
    ...
    console.log("网页课件区域宽（包括边线的宽：" + document.body.offsetWidth);
    ...
    audio.addEventListener("ended", function (event) {
        ...
        //music.style.animationPlayState = "paused"; //兼容有问题，android4.4以下不行，IOS 6以下不行
    ...
    //         this.style.webkitAnimationPlayState = "running"; //兼容IOS 6，但是android 4.4 以下还是不行
    //     }
    //     else {
    //         audio.pause();
    //         //this.setAttribute("class", ""); //不会继续，动画会回到原点
    //         this.style.animationPlayState = "paused"; //兼容有问题，android4.4以下不行，IOS 6以下不行
